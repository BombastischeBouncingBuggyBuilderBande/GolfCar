...
if(isset($_POST['name']) && isset($_POST['datum']) && isset($_POST['as']) && isset($_POST['beschreibung']) && isset($_POST['currentPage'])){
    ...
    echo json_encode(array('success' => 1, 'entries' => createInformationBox(createTeamspaceTable($db, $name, $currentpage), $name, $currentpage))); // Funktionen aus Teamspace_PHPFunctions.php
